  ...
  return (
    <div className="flex h-full flex-col border-l border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p
              className={`mt-1 text-2xl font-bold ${getProbabilityColor(
      ...
      <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
        ...
        {isExpanded && (
          <p className="mt-2 text-center text-xs text-gray-500 dark:text-gray-400">
            Los futuros ya fueron generados y están visibles en el árbol
          </p>
        )}
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
                ...
                >
                  ...
                  <div className="mb-2 flex items-center gap-4 text-xs text-gray-600 dark:text-gray-400">
                    <div className="flex items-center gap-1">
                      ...
                      <span
                        className={`font-bold ${getProbabilityColor(
                          market.probability
                        )}`}
                      >
                        {market.probability}%
        ...
        {consequence.polymarketQueries &&
          consequence.polymarketQueries.length > 0 && (
            <div>
              <h4 className="mb-3 text-sm font-medium text-gray-900 dark:text-white">
              ...
              <div className="flex flex-wrap gap-2">
                {consequence.polymarketQueries.map((query, index) => (
                  <a
                    key={index}
                    href={`https://polymarket.com/search?q=${encodeURIComponent(
                      query
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
